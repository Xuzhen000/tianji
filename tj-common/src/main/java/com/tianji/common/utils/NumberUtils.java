...
public class NumberUtils extends NumberUtil {
    ...
    public static String scaleToStr(Integer thresholdAmount, int i) {
        int num = 1;
        while (i > 0){
            num = num * 10;
            i--;
        ...
        return BigDecimal.valueOf(thresholdAmount).divide(new BigDecimal(num), RoundingMode.CEILING).toString();
    }
}
